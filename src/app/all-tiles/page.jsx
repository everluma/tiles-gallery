      ...
      <div className="max-w-[1400px] mx-auto mb-16 text-center">
        ...
        <div className="relative max-w-xl mx-auto">
          <input
            ...
            className="w-full bg-[#242424] border border-gray-800 py-4 px-6 rounded-sm focus:outline-none focus:border-[#B88E2F] transition-all placeholder:text-gray-600 text-white"
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {filtered.length > 0 ? (
          ...
          <div className="col-span-full text-center py-20">
            <p className="text-gray-500 text-xl font-light">No tiles found matching your search.</p>
          </div>
        )}
      </div>
    </div>
