        ...
        <div className="bg-[#242424] border border-gray-800 shadow-2xl overflow-hidden rounded-sm">
          ...
          <div className="p-8 md:p-12">
            <form className="space-y-8">
              ...
              {/* Action Button */}
              <button className="w-full bg-[#B88E2F] hover:bg-[#a07b28] text-white py-4 font-bold uppercase tracking-widest transition-all shadow-xl active:scale-95 text-xs mt-4">
                Update Now
              </button>
            </form>
          </div>
